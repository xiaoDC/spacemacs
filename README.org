...
** How to use
Follow the install instruction here: https://github.com/fri3nds/spacemacs#install ,
make sure your are using the fork repo: https://github.com/fri3nds/spacemacs
